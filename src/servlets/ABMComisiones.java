		...
		switch (request.getParameter("modo")) {
			...
			case "editar-comision":				
				try {
					...
					request.setAttribute("mensaje","No se ha podido editar la comision. Intente mas tarde.");
			...
			case "alta-comision":				
				try {
					...
					request.setAttribute("mensaje","No se ha podido agregar la comision. Intente mas tarde.");
					request.setAttribute("direccion-volver","admin-home?param=admin-home");
					request.setAttribute("mensaje-volver", "Volver al Home");
			    	request.getRequestDispatcher("WEB-INF/error.jsp").forward(request, response);
				}
			...
			case "eliminar-comision":	
				try{
					...
					request.setAttribute("mensaje","No se ha podido eliminar la comision. Intente mas tarde.");
					request.setAttribute("direccion-volver","admin-home?param=admin-home");
					request.setAttribute("mensaje-volver", "Volver al Home");
			    	request.getRequestDispatcher("WEB-INF/error.jsp").forward(request, response);
				}
